...
export default {
     ...
     * @returns {function(*)}
     */
    fetchNetworkTransactionTbApi(_props){
        ...
        return (dispatch) => {
            ...
            let url = `${Object.curRequestUrlDomain}/networks/${props.param.id}/transactions?page=${props.baseReducer.pagination.current}&per_page=${props.baseReducer.pagination.pageSize}${param}`;
