/**
 * ReviewPurchaseTbApi.js
 * ReviewPurchase 页面的tb的 api
 */
import *as antTableActions from '../../redux/action/antTableActions'

export default {
    apiName: 'ReviewPurchaseTbApi',
    ...
    fetchTbDataApi(_props){
        ...
        return (dispatch) => {
            ...
            let url = `${Object.curRequestUrlDomain}/purchases?page=${props.baseReducer.pagination.current}&per_page=${props.baseReducer.pagination.pageSize}&status=REVIEWING&embeds=cashbacks${param}`;
