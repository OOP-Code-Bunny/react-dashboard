...
import ZanoxTbApi from '../../network/api/ZanoxTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], ZanoxTbApi.apiName)
    .setIn(['scroll'], {
...
export default function ZanoxTableReducer(state = initialState, action) {
