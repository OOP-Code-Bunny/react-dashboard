...
import LinkTechTbApi from '../../network/api/LinkTechTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], LinkTechTbApi.apiName)
    .setIn(['scroll'], {
...
export default function LinkTechTableReducer(state = initialState, action) {
