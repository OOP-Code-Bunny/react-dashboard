...
import SkimlinksTbApi from '../../network/api/SkimlinksTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], SkimlinksTbApi.apiName)
    .setIn(['scroll'], {
...
export default function SkimlinksTableReducer(state = initialState, action) {
