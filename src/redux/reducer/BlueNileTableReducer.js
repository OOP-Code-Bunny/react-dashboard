...
import BlueNileTbApi from '../../network/api/BlueNileTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], BlueNileTbApi.apiName)
    .setIn(['scroll'], {
...
export default function BlueNileTableReducer(state = initialState, action) {
