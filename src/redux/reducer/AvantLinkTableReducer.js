...
import AvantLinkTbApi from '../../network/api/AvantLinkTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], AvantLinkTbApi.apiName)
    .setIn(['scroll'], {
...
export default function AvantLinkTableReducer(state = initialState, action) {
