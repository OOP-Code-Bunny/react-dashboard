...
import PepperjamTbApi from '../../network/api/PepperjamTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], PepperjamTbApi.apiName)
    .setIn(['scroll'], {
...
export default function PepperjamTableReducer(state = initialState, action) {
