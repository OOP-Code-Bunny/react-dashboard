...
import AdwaysTbApi from '../../network/api/AdwaysTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], AdwaysTbApi.apiName)
    .setIn(['scroll'], {
...
export default function AdwaysTableReducer(state = initialState, action) {
