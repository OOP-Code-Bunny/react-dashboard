...
import AmazonTbApi from '../../network/api/AmazonTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], AmazonTbApi.apiName)
    .setIn(['scroll'], {
...
export default function AmazonTableReducer(state = initialState, action) {
