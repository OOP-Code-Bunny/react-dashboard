...
import WebgainsTbApi from '../../network/api/WebgainsTbApi'
import {filterActions} from './index'
const initialState = new antTableInitialState()
    .setIn(['apiName'], WebgainsTbApi.apiName)
    .setIn(['scroll'], {
...
export default function WebgainsTableReducer(state = initialState, action) {
